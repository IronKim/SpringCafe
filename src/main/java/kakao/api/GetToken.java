...
public class GetToken {
	...
	public String Token(String code, String id, String secret) {
		try{
	        ...
	        params.add("redirect_uri","http://localhost:8080/miniProject/admin/token");
	...
	public void updateToken(String token) {
	        try {
	            ...
	            Resource resource = new ClassPathResource("spring/token.properties");
	            ...
	            fileContent = fileContent.replaceAll("refresh.token=.*", "refresh.token=" + token);
